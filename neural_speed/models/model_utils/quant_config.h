...
enum class quant_bits : int { q4 = 0, q1, q2, q3, q5, q6, q7, q8, fp4_e2m1, nf4, fp8_e4m3, fp8_e5m2, count };
static inline quant_bits parse_bits(const std::string& bits) {
  ...
  if (bits == "int1") {
    return quant_bits::q1;
  }
  if (bits == "int5") {
    return quant_bits::q5;
  }
  if (bits == "int6") {
    return quant_bits::q6;
  }
  if (bits == "int7") {
    return quant_bits::q7;
  }
  if (bits == "int4") {
