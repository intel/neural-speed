...
static void ne_compute_forward_mul_mat_q_f32_bestla(const struct ne_compute_params* params, const struct ne_tensor* src0,
                                                   const struct ne_tensor* src1, struct ne_tensor* dst) {
  int64_t t0 = ne_perf_time_us();
  UNUSED(t0);
...
static void ne_compute_forward_mul_mat_bias_q_f32_bestla(const struct ne_compute_params* params,
  ...
  bestla_fusion_add_f32f32_forward((float*)src1->data, src0->data, (float*)bias->data, (float*)dst->data, ne1, ne0, ne10,
...
static void ne_compute_forward_ffn_gelu(const struct ne_compute_params* params, const struct ne_tensor* src,
  ...
  const int fmid = w1->ne[1];
  const int seq = dst->ne[1];
  bestla_fusion_FFN_GeLu_f32f32_forward((float*)src->data, w1->data, w2->data, (float*)tmp->data, (float*)dst->data, seq,
