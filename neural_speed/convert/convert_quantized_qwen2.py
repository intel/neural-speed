...
def main(args_in: Optional[List[str]] = None) -> None:
    ...
    for i in range(hparams["num_hidden_layers"]):
        ...
        # ffn GEMM
        convert_to_qx_bestla_tensor(f"model.layers.{i}.mlp.down_proj.weight", f"model.layers.{i}.mlp.down_proj.weight",
                                    list_vars, f, quantize_config)
        convert_to_qx_bestla_tensor(f"model.layers.{i}.mlp.gate_proj.weight", f"model.layers.{i}.mlp.gate_proj.weight",
                                    list_vars, f, quantize_config)
