...
def main(args_in: Optional[List[str]] = None) -> None:
    ...
    fout.write(struct.pack("i", 0))
    fout.write(struct.pack("i", hparams["num_local_experts"]))  # n_experts
    fout.write(struct.pack("i", hparams["num_experts_per_tok"]))  # n_expert_used
    fout.write(struct.pack("i", 0)) # n_embd_head_k
