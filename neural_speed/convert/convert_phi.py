...
def main(args_in: Optional[List[str]] = None) -> None:
    ...
    fout.write(struct.pack("i", hparams["nlayers"]))
    ...
    fout.write(struct.pack("i", tokenizer.pad_token_id if tokenizer.bos_token_id is not None else -1))
    fout.write(struct.pack("i", tokenizer.pad_token_id if tokenizer.eos_token_id is not None else -1))
