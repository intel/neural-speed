...
#pragma unroll
          for (uint32_t ii = 0; ii < block_size_y_b; ii += step) {
            ...
            uint32_t scale_idx =
                ...
                offset_x_in_tile;
            typename scale_t::dtype scale_value = scale.reg[scale_idx];
            typename scale_t::dtype add_number;
            ...
            if constexpr (quant_mode == quant_mode::S4_ASYM) {
              ...
              int8_t zero_pt_i8 =
                  ...
                  0xf;
              add_number = scale_value * typename scale_t::dtype(zero_pt_i8);
            } else if constexpr (quant_mode == quant_mode::S4_FULLRANGE_NO_ZP) {
              add_number = scale_value * typename scale_t::dtype(-8);
            }
#pragma unroll
