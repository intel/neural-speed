...
public:
    ...
    virtual void *NewSequence(
            const Mark &mark, const std::string &tag, void *pParentNode)
            = 0;
...
void *BuildGraphOfNextDocument(
        Parser &parser, GraphBuilderInterface &graphBuilder);
