...
#define UT_START() printf("Test Class: %s\n", __FUNCTION__)
template <typename _T>
static float buffer_error(_T* ref, _T* tar, size_t size, _T thres = _T(0)) {
  float err = 0;
  int cnt = 0;
...
template <>
float buffer_error(jblas::utils::bf16* ref, jblas::utils::bf16* tar, size_t size, jblas::utils::bf16 thres) {
  float err = 0;
  int cnt = 0;
  float max_err = 0, max_a = 0.f, max_b = 0.f;
  int constexpr MAX_PRINT = 10;
...
template <>
float buffer_error(float* ref, float* tar, size_t size, float thres) {
  float err = 0;
  int cnt = 0;
  float max_err = 0, max_a = 0.f, max_b = 0.f;
  int constexpr MAX_PRINT = 10;
...
template <typename _T>
static float buffer_error_2d(_T* ref, _T* tar, size_t row, size_t col, size_t refstep, size_t tarstep,
                             _T thres = _T(0)) {
  float err = 0;
  int cnt = 0;
  int constexpr MAX_PRINT = 10;
