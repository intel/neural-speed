...
inline BTLA_CODE decompress_kblock_s3_s8fp(utils::bit2x4* bit2ptr, utils::bit1x8* bit1ptr, _DST_T* dstptr,
  ...
  auto bit3_interleave_decompress_pack128 = [&](utils::bit2x4* src1, utils::bit1x8* src2, int8_t* dst) {
    ...
    const __m128i bit2_0 = _mm_loadu_si128((const __m256i*)src1);
    auto bit2_1 = _mm_srli_epi16(bit2_0, 2);
    auto bit2_2 = _mm_srli_epi16(bit2_0, 4);
    auto bit2_3 = _mm_srli_epi16(bit2_0, 6);
    auto g2_0 = _mm256_inserti128_si256(_mm256_castsi128_si256(bit2_0), bit2_1, 0x1);  // lat3, tp1 uop1 p:5
    auto g2_1 = _mm256_inserti128_si256(_mm256_castsi128_si256(bit2_2), bit2_3, 0x1);
