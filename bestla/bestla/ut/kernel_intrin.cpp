...
class UT_Avx512f_decompress_kblock_s4_fp {
 public:
  UT_Avx512f_decompress_kblock_s4_fp() {
    UT_START();
    CheckISA(AVX512F);
    ut<JBLAS_DTYPE::S4_CLIP, 2, float, utils::bf16>(32, 128, 128, 128, 0, 32, 128);
    ut<JBLAS_DTYPE::S4_CLIP, 2, float, utils::bf16>(32, 96, 96, 96, 0, 32, 96);
