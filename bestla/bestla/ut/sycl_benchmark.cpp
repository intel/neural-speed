...
#pragma unroll
  ...
  void benchmark_all(int m, int n, int k) {
    ...
    if (m == 1) {
      ...
      benchmark<LOG>(m, n, k, batch, dA.data(), dBs8.data(), dB_scale.data(), dC.data(), testtime);
    }
  }
};
