...
struct igemm_quantize_func {
  ...
  static inline void run(
    ...
    typename gemm_op_t::arguments_t arg(
        ...
        mat_n,
        A,
        mem_layout_a == mem_layout::col_major ? mat_m : mat_k,
        B,
        mem_layout_b == mem_layout::col_major ? mat_k : mat_n,
        C,
        mat_n,
        typename epilogue_t::arguments_t(
            typename dequant_op_t::arguments_t{
                {{scale}, {mat_n, 1, mat_n}, {offset}, {mat_n, 1, mat_n}}},
