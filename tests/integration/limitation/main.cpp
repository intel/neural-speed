...
TEST(slm, check_aligment) {
  EXPECT_TRUE(
      (core::general_1d<gpu_arch::Xe, uint32_t>::template check_restriction<1>(
          0)));
  EXPECT_FALSE((
      core::general_1d<gpu_arch::Xe, float>::template check_restriction<1>(1)));
  EXPECT_FALSE((
      core::general_1d<gpu_arch::Xe, float>::template check_restriction<1>(2)));
  EXPECT_FALSE((
      core::general_1d<gpu_arch::Xe, float>::template check_restriction<1>(3)));
  EXPECT_TRUE((
      core::general_1d<gpu_arch::Xe, float>::template check_restriction<1>(4)));
  EXPECT_FALSE((
      core::general_1d<gpu_arch::Xe, float>::template check_restriction<1>(5)));
  EXPECT_FALSE((
      core::general_1d<gpu_arch::Xe, float>::template check_restriction<1>(6)));
  EXPECT_FALSE((
      core::general_1d<gpu_arch::Xe, float>::template check_restriction<1>(7)));
  EXPECT_TRUE((
      core::general_1d<gpu_arch::Xe, float>::template check_restriction<1>(8)));
}
...
TEST(block_2d, check_load) {
  ...
  EXPECT_FALSE(
      (core::block_2d<gpu_arch::Xe, fp16>::template check_load<false, false>(
          td)));
