...
template <
    ...
    int wg_num_m,
    int wg_num_n,
    ln_bwd_fused_kind fused_op_kind>
struct ln_bwd_func_t {
  using layer_norm_attr = gpu::xetla::kernel::
      layer_norm_attr_t<wg_n, wg_m, sg_n, sg_m, wg_num_m, wg_num_n>;
  using ln_fused_op = gpu::xetla::group::ln_bwd_fused_op_t<
      fused_op_kind,
      dtype_y,
      dtype_x,
      dtype_acc,
...
struct ln_bwd_final_func_t {
  using reduction_attr = gpu::xetla::kernel::row_reduction_attr_t<
      final_wg_n,
      final_wg_m,
      final_sg_n,
      final_sg_m,
      false>;
  using row_reduction0 = gpu::xetla::kernel::xetla_row_reduction_t<
      dtype_acc,
      dtype_weight,
      dtype_acc,
      reduction_attr,
