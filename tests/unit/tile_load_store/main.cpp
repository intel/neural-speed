...
TEST(tile_load_transpose_store_3, esimd) {
    cl::sycl::nd_range<1> nd_range({1}, {1});
    auto result_validate
            = std::bind(tile_load_store_result_validate<int, false, true>, _1,
                    _2, _3, 32, 32, 32, 32, 0);
    kernel_run<int,
            tile_load_store_func<int, 32, 32, 32, 32, 32, 8, 8, false, true, 64,
                    gpu_arch::Dg2>>(nd_range, result_validate);
}

// TEST(tile_load_transpose_store_4, esimd) {
//     cl::sycl::nd_range<1> nd_range({1}, {1});
//     auto result_validate
//             = std::bind(tile_load_store_result_validate<int, false, true>, _1,
//                     _2, _3, 32, 32, 32, 32, 0);
//     kernel_run<int,
//             tile_load_store_func<int, 32, 32, 32, 32, 32, 8, 16, false, true,
//                     64, gpu_arch::Dg2>>(nd_range, result_validate);
// }
