...
//       tile_padding_load_store_result_validate<int>, _1, _2, _3, 16, 16, -1, -1);
//   kernel_run<
//       int,
//       tile_padding_load_store_func<int, 16, 16, 16, 16, 16, 16, 16, -1, -1>>(
...
//   cl::sycl::nd_range<1> nd_range({1}, {1});
//   auto result_validate = std::bind(
//       tile_padding_load_store_result_validate<int>, _1, _2, _3, 16, 16, 0, -1);
//   kernel_run<
//       int,
//       tile_padding_load_store_func<int, 16, 16, 16, 16, 16, 16, 16, 0, -1>>(
//       nd_range, result_validate);
// }
...
//   cl::sycl::nd_range<1> nd_range({1}, {1});
//   auto result_validate = std::bind(
//       tile_padding_load_store_result_validate<int>, _1, _2, _3, 16, 16, -1, 0);
//   kernel_run<
//       int,
//       tile_padding_load_store_func<int, 16, 16, 16, 16, 16, 16, 16, -1, 0>>(
//       nd_range, result_validate);
// }
...
//   cl::sycl::nd_range<1> nd_range({1}, {1});
//   auto result_validate = std::bind(
//       tile_padding_load_store_result_validate<int>, _1, _2, _3, 16, 16, 0, 0);
//   kernel_run<
//       int,
//       tile_padding_load_store_func<int, 16, 16, 16, 16, 16, 16, 16, 0, 0>>(
//       nd_range, result_validate);
// }
...
//   cl::sycl::nd_range<1> nd_range({1}, {1});
//   auto result_validate = std::bind(
//       tile_load_store_result_validate<int>, _1, _2, _3, 128, 64, 32, 32, 0);
//   kernel_run<
//       int,
...
//   cl::sycl::nd_range<1> nd_range({1}, {1});
//   auto result_validate = std::bind(
//       tile_load_store_result_validate<int, false, true>,
//       _1,
//       _2,
//       _3,
//       128,
...
//   kernel_run<
//       int,
//       tile_load_store_func<int, 128, 64, 128, 32, 32, 8, 8, false, true, 64>>(
//       nd_range, result_validate);
// }
...
//   kernel_run<
//       int,
//       tile_load_store_func<int, 128, 64, 128, 32, 32, 8, 16, false, true, 64>>(
//       nd_range, result_validate);
// }
...
TEST(tile_load_transform_store, esimd) {
  cl::sycl::nd_range<1> nd_range({1}, {1});
  auto result_validate = std::bind(
      tile_load_store_result_validate<bf16, true>,
      _1,
      _2,
      _3,
      128,
  ...
  kernel_run<
      bf16,
      tile_load_store_func<bf16, 128, 64, 128, 32, 32, 16, 16, true, false>>(
      nd_range, result_validate);
}
...
//   cl::sycl::nd_range<1> nd_range({1}, {1});
//   auto result_validate = std::bind(
//       tile_load_store_result_validate<float>, _1, _2, _3, 128, 64, 32, 32,
//       0);
//   kernel_run<
//       float,
...
//   cl::sycl::nd_range<1> nd_range({1}, {1});
//   auto result_validate = std::bind(
//       tile_load_store_result_validate<float>, _1, _2, _3, 30, 31, 32, 32, 0);
//   kernel_run<
//       float,
...
//   cl::sycl::nd_range<1> nd_range({1}, {1});
//   auto result_validate = std::bind(
//       tile_load_broadcase_store_result_validate<int>, _1, _2, _3, 128, 32,
//       32);
//   kernel_run<
//       int,
...
//   cl::sycl::nd_range<1> nd_range({1}, {1});
//   auto result_validate = std::bind(
//       tile_load_store_result_validate<int>, _1, _2, _3, 128, 64, 127, 1, 0);
//   kernel_run<int, tile_load_store_1d_func<int, 128, 64, 128, 127, 1, 127,
//   1>>(
//       nd_range, result_validate);
// }
...
//   auto result_validate = std::bind(
//       tile_load_store_result_validate<date_type>,
//       _1,
//       _2,
//       _3,
//       127,
...
//   kernel_run<
//       date_type,
//       tile_load_store_unaligned_2d_func<
//           date_type,
//           127,
//           63,
//           127,
...
//   cl::sycl::nd_range<1> nd_range({1}, {1});
//   auto result_validate = std::bind(
//       tile_load_store_result_validate<bf16, false, true>,
//       _1,
//       _2,
//       _3,
//       64,
