...
struct gelu_fwd_w_op {
  ...
  static dtype run(dtype x) {
    ...
    float result = 0.5f * (1 + z) +
        0.5f * x * (1.f - z * z) * (sqrt_two_over_pi * (1.f + D0 * x * x));
    return result;
  }
};
...
template <typename dtype>
int tile_elemwise_bias_add_validate(
    dtype* A,
    [[maybe_unused]] dtype* B,
    dtype* C,
    unsigned Sizex,
...
template <typename dtype>
int tile_elemwise_gelu_bwd_validate(
    dtype* A,
    [[maybe_unused]] dtype* B,
    dtype* C,
    unsigned Sizex,
...
template <typename dtype>
int tile_elemwise_res_add_validate(
    dtype* A,
    [[maybe_unused]] dtype* B,
    dtype* C,
    unsigned Sizex,
...
template <typename dtype>
int tile_elemwise_linear_op_validate(
    dtype* A,
    [[maybe_unused]] dtype* B,
    dtype* C,
    unsigned Sizex,
